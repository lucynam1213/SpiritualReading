...
하지만 이런 온전한 믿음을 갖기란 결코 쉬운 일이 아니므로 너는 새로운 나라와 현재 살고 있는 이곳의 경계를 넘나들며 망설일 때가 많다. 한동안은 새로운 나라에 들어가서도 진정한 기쁨을 맛보며 행복해할지 모른다. 그러나 그 후 두려움과 떠나온 곳에 대한 미련으로 발길을 되돌리게 될 것이다. 그래서 다시 돌아와 보면 더이상 매력적인 곳도, 네가 바라던 곳도 아니라는 사실을 깨닫게 되어 깊이 절망하게 될 것이다. 그러므로 두렵더라도 새로운 나라를 향해 용기있게 걸음을 내디뎌야 한다. 그곳으로 가면 진정한 행복과 평안을 느끼게 될 거라고 굳게 믿으면서 말이다.`
  },
  {
    type: "chapter",
    title: "하느님을 떠나지 말라",
    content: `다른 사람으로부터 사랑받고 싶다는 바람이 커지면 우선 네가 처한 상황과 곁에 있는 사람들이 정말 하느님이 바라시는 대로인지 자신에게 물어보아야 한다. 영화를 보든, 책을 쓰든, 발표를 하든, 무엇을 먹든, 자든, 아니면 다른 무엇을 하든 너는 하느님과 함께해야 한다는 사실을 잊지 말아야 한다. 외로움이 사무쳐 견디기가 어렵거나 다른 사람과의 우정이나 사랑을 갈망하게 될 때도 정신을 바짝 차리고 이런 상황이 하느님이 허락하신 것인지를 물어보아야 한다. 왜냐하면 하느님과 함께하는 곳에서는 비록 고통스러운 순간이 있을지라도 그분이 너를 지켜주시고 평화를 주시기 때문이다.

하느님과 함께하는 삶을 살고 싶다면 절제되고 바른 생활을 해야 한다. 영적인 삶에 관심을 가지고 마음속에서 들려오는 하느님의 말씀에 귀를 기울일수록 하느님과 함께하는 삶과 그렇지 못한 삶을 구분하기가 더욱 쉬워지고 하느님이 함께하지 않는 곳을 버리고 떠나오기가 더욱 쉬워진다.

하느님과 함께하는 삶을 살기 위해서는 매 순간 선택의 기로에 섰을 때 하느님에 대한 확고한 믿음을 가지고 선택해야 한다. 먹거나 마시거나 일하거나 놀 때, 그리고 말을 하거나 글을 쓸 때도 하느님의 영광을 위해 하는 것이 아니라는 생각이 들면 즉시 그 일을 멈추어야 한다. 하느님의 영광을 위해 살지 않는다는 것은 네 자신의 영광을 위해 살기 시작했다는 뜻이며 이는 네가 하느님을 떠나와서 결국에는 스스로를 망치게 됨을 의미하기 때문이다.

무슨 일을 하든지 그것이 하느님과 함께하는 일인지 아닌지를 늘 스스로에게 물어보아야 한다. 너는 이미 이 질문에 대한 해답을 알고 있다. 다른 사람으로부터 인정받고 받아들여지고 사랑받고 싶다는 바람에서 무슨 일을 하면, 그리고 이런 인간적인 바람이 커지도록 내버려 둔다면 하느님은 더 이상 네 곁에 계시지 않는다는 사실을 알아야 한다. 인간의 바람과 욕망은 끝이 없어서 이에 굴복하면 할수록 더욱 커질 뿐이다. 그러나 하느님의 영광을 위해 생활한다면 너는 하느님의 평화를 느끼게 될 것이다.
`
  },
  {
    type: "chapter",
    title: "영적 인도자에게 의지하라",
    content: `하느님과 함께하는 삶은 결코 쉽지 않다. 그래서 하느님께서는 너를 지켜주고 방황할 때마다 잡아주는 영적인 인도자를 보내셨다. 그들은 네가 가장 큰 바람을 어떻게 하면 이룰 수 있는지 가르쳐 준다. 물론 그 방법을 모르는 바는 아니지만 확신을 갖지 못하는 경우가 많다.

그러므로 하느님이 보내신 영적 인도자를 믿고 의지해야 한다. 때로는 그들이 엄격하고 비현실적이며 너무 많은 것을 요구한다는 생각이 들때도 있을 것이다. 심지어 네 욕구와 바람에 대해서 신경도 쓰지 않는 듯한 느낌을 받을 때도 있을 것이다. 그러나 이렇게 영적 인도자에 대한 믿음이 허물어지는 바로 그때가 외부 세계의 유혹에 넘어갈 위험에 빠지게 된다. '영적 인도자는 내가 지겨워 졌나 봐. 나는 끼워주지도 않고 저희들끼리만 내 얘기를 하고 있으니. 마치 병에 대해서 다 알려주면 안 되는 환자 처럼 날 취급하고 있잖아.'라는 생각이 들면 그건 위험 신호다.

너는 영적 인도자와의 사이에 오해가 생기지 않도록 늘 신경을 써야 한다. 마음속에 그들에 대한 불신이 싹트기 시작하면 이 사실을 즉시 그들에게 알려야 한다. 그래야 그들이 상상과 오해 때문에 네가 그들로부터 멀어지지 않도록 다른 조치를 취하고 불신과 오해를 씻고 다시 관계를 회복할 수 있기 때문이다.`
  },
  {
    type: "chapter",
    title: "고통을 피하지 말라",
    content: `너는 고통을 피하지 말고 견뎌냄으로써 고통의 힘이 서서히 약해지도록 해야 한다. 물론 자유로운 새 나라에 대한 확신이 있어야 고통에 직면하는 것이 가능하다. 이런 확신 없이 고통을 무조건 참기만 한다면 새로운 나라로 들어가는 것은 요원한 일이 될 것이다.

너에게 지워진 고통의 짐은 무엇인가? 고통은 네가 진정으로 바라는 것을 얻지 못하는 데서 생긴다. 고통은 그토록 갈망하는 사랑을 받지 못하는 데서 오는 공허감이다. 그리고 상처와 네 자신의 나약한 모습을 그대로 직면하기 때문에 고통을 피하지 않고 견뎌내기란 결코 쉬운 일이 아니다. 그러므로 고통을 두려워하고 고통은 곧 죽음이라고 생각하는 것도 무리가 아니다. 그래서 너는 살기 위해서라도 고통으로부터 도망쳐 안식을 주는 곳을 찾아 헤매게 된다. 이 세상에서는 그런 곳을 찾을 수 없다는 것을 잘 알면서도 말이다.

너는 허무가 삶의 전부가 아니며 그것을 넘어 사랑으로 우리를 채워줄 곳이 있다는 사실을 굳게 믿어야 한다. 이런 믿음이 없으면 고통을 직면할 수 없다.

그러므로 너는 마음의 평화를 주는 새로운 나라를 이미 찾았다는 확신을 가지고 고통을 피하지 말고 견뎌내야 한다. 이미 너는 새로운 나라의 열매를 맛보았다. 여기에 대해 확고한 믿음을 가지면 네가 겪은 고통에 대해 슬퍼하며 이를 떠나보낼 수 있다. 너는 네게 영향력을 잃은 것에 대해서는 슬퍼할 수 있지만 아직도 주변을 맴돌며 영향력을 미치고 있는 것에 대해서는 슬퍼할 수가 없다. 이제 너에게 너무 큰 상처를 주었던 고통과 애착, 욕망과 바람을 모두 묻어버려야 할 때가 된 것이다.

한때 너를 눈물로 지새우게 했던 고통을 애도하며 떠나 보내야 한다. 그리고 우울함과 향수를 씻어버리고 고통에서 자유로워진 몸으로 새로운 나라에서 새로운 삶을 향유해야 한다.`
  }
];
